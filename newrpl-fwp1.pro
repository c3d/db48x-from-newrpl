...
#    firmware/sys/target_prime1/flash.c \
...
DISTFILES += \
    firmware/target_prime1/ld.script
...
#QMAKE_AR_CMD = arm-none-eabi-ld --verbose -T$$PWD/firmware/target_prime1/ld.script -nodefaultlibs -nostdlib -L$$GCC_LIBDIR $(OBJECTS) -lgcc -o $(TARGET).elf
...
QMAKE_LFLAGS_SHAPP =
QMAKE_LFLAGS_THREAD =
QMAKE_LFLAGS = -g -T$$PWD/firmware/target_prime1/ld.script -nodefaultlibs -nostdlib -L$$GCC_LIBDIR
