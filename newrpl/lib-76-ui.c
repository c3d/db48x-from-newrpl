...
#define COMMAND_LIST \
    CMD(COPYCLIP,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(CUTCLIP,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(PASTECLIP,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(WAIT,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(KEYEVAL,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(KEY,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(DOFORM,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDINSERT,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,2,2)), \
    CMD(EDREMOVE,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDLEFT,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDRIGHT,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDUP,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDDOWN,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDSTART,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDEND,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDLSTART,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDLEND,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDTOKEN,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDACTOKEN,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(EDMODE,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(SETTHEME,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(GETTHEME,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2))
