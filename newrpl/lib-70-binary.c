...
#define COMMAND_LIST \
    CMD(STWS,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(RCWS,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(BOR,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(BAND,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BXOR,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BLSL,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BLSR,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BASR,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BRL,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(BRR,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(BNOT,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BADD,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BSUB,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BMUL,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BDIV,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(BNEG,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2))
