...
void LIB_HANDLER()
{
    ...
    case OPCODE_COMPILE:
        ...
        if((TokenLen == 5)
                && (!utf8ncmp2((char *)TokenStart, (char *)BlankStart, "ENDDO",
                        5))) {
            // ENDDO
    ...
    case OPCODE_GETINFO:
        ...
        if(ISPROLOG(*ObjectPTR)) {
            ...
            case DO:
                DecompHints =
                        HINT_NLBEFORE | HINT_NLAFTER | HINT_ADDINDENTAFTER;
                break;
            case CASE:
            case REPEAT:
            case THEN:
            ...
            case STEP:
                DecompHints =
                        HINT_NLBEFORE | HINT_SUBINDENTBEFORE | HINT_NLAFTER;
                break;
            case ELSE:
            case ELSEERR:
