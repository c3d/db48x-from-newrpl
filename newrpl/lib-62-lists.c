...
#define LIB_ENUM lib62_enum
#define LIB_NAMES lib62_names
#define LIB_HANDLER lib62_handler
#define LIB_NUMBEROFCMDS LIB62_NUMBEROFCMDS
#define ROMPTR_TABLE    romptr_table62
