...
#define COMMAND_LIST \
    CMD(SIN,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(COS,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(TAN,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(ASIN,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(ACOS,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(ATAN,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(ATAN2,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(LN,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(EXP,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(SINH,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(COSH,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(TANH,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(ASINH,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(ACOSH,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(ATANH,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(LOG,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(ALOG,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    ECMD(SQRT,"√",MK_TOKEN_INFO(1,TITYPE_PREFIXOP,1,3)), \
    CMD(EXPM,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(LNP1,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    ECMD(PINUM,"π0",MK_TOKEN_INFO(2,TITYPE_NOTALLOWED,0,2))
