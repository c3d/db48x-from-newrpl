...
#define COMMAND_LIST \
    ECMD(TOARRAY,"→ARRY",MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    ECMD(ARRAYDECOMP,"ARRY→",MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    ECMD(TOCOL,"→COL",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(ADDCOL,"COL+",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(REMCOL,"COL-",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(FROMCOL,"COL→",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(TODIAG,"→DIAG",MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    ECMD(FROMDIAG,"DIAG→",MK_TOKEN_INFO(4,TITYPE_FUNCTION,2,2)), \
    ECMD(TOROW,"→ROW",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(ADDROW,"ROW+",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(REMROW,"ROW-",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(FROMROW,"ROW→",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(TOV2,"→V2",MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    ECMD(TOV3,"→V3",MK_TOKEN_INFO(3,TITYPE_FUNCTION,3,2)), \
    ECMD(FROMV,"V→",MK_TOKEN_INFO(2,TITYPE_NOTALLOWED,1,2)), \
    ECMD(DOMATPRE,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,1,2)), \
    ECMD(DOMATPOST,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,1,2)), \
    ECMD(DOMATERR,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,1,2)), \
    /*CMD(AUGMENT,MK_TOKEN_INFO(7,TITYPE_FUNCTION,1,2)),*/ \
    CMD(AXL,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    /*CMD(AXM,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)),*/ \
    CMD(BASIS,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(CHOLESKY,MK_TOKEN_INFO(8,TITYPE_FUNCTION,1,2)), \
    CMD(CNRM,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(CON,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(COND,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(CROSS,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(CSWP,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(DET,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(DIAGMAP,MK_TOKEN_INFO(7,TITYPE_FUNCTION,1,2)), \
    CMD(DOT,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(EGV,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(EGVL,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(GRAMSCHMIDT,MK_TOKEN_INFO(11,TITYPE_FUNCTION,1,2)), \
    CMD(HADAMARD,MK_TOKEN_INFO(8,TITYPE_FUNCTION,1,2)), \
    CMD(HILBERT,MK_TOKEN_INFO(7,TITYPE_FUNCTION,1,2)), \
    CMD(IBASIS,MK_TOKEN_INFO(6,TITYPE_FUNCTION,1,2)), \
    CMD(IDN,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(IMAGE,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(ISOM,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(JORDAN,MK_TOKEN_INFO(6,TITYPE_FUNCTION,1,2)), \
    CMD(KER,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(LQ,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(LSQ,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(LU,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(MAD,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(MKISOM,MK_TOKEN_INFO(6,TITYPE_FUNCTION,1,2)), \
    CMD(PMINI,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(QR,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(RANK,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(RANM,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(RCI,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(RCIJ,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(RDM,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(REF,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(RNRM,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(RREF,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(RREFMOD,MK_TOKEN_INFO(7,TITYPE_FUNCTION,1,2)), \
    CMD(RSD,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(RSWP,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(SCHUR,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(SNRM,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(SRAD,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(SVD,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(SVL,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(SYLVESTER,MK_TOKEN_INFO(9,TITYPE_FUNCTION,1,2)), \
    CMD(TRACE,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(TRAN,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(TRN,MK_TOKEN_INFO(3,TITYPE_FUNCTION,1,2)), \
    CMD(VANDERMONDE,MK_TOKEN_INFO(11,TITYPE_FUNCTION,1,2)), \
    CMD(LDUP,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(MMAP,MK_TOKEN_INFO(4,TITYPE_CASFUNCTION,2,2)), \
    ECMD(DOMMAPPRE,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,0,2)), \
    ECMD(DOMMAPPOST,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,0,2)), \
    ECMD(DOMMAPERR,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,0,2))
...
ROMOBJECT matrixeval_seco[] = {
    MK_PROLOG(DOCOL, 5),
    MK_OPCODE(LIBRARY_NUMBER, DOMATPRE), // PREPARE EACH ELEMENT
    (CMD_OVR_EVAL),     // DO THE EVAL
    MK_OPCODE(LIBRARY_NUMBER, DOMATPOST),        // POST-PROCESS RESULTS AND CLOSE THE LOOP
    MK_OPCODE(LIBRARY_NUMBER, DOMATERR), // ERROR HANDLER
    CMD_SEMI
};

ROMOBJECT matrixmap_seco[] = {
    MK_PROLOG(DOCOL, 5),
    MK_OPCODE(LIBRARY_NUMBER, DOMMAPPRE),        // PREPARE EACH ELEMENT
    (CMD_OVR_XEQ),      // DO THE EVAL
    MK_OPCODE(LIBRARY_NUMBER, DOMMAPPOST),       // POST-PROCESS RESULTS AND CLOSE THE LOOP
    MK_OPCODE(LIBRARY_NUMBER, DOMMAPERR),        // ERROR HANDLER
    CMD_SEMI
};
...
ROMOBJECT rowindex_ident[] = {
    MK_PROLOG(DOIDENT | UNQUOTED_BIT, 1),
    TEXT2WORD('i', 0, 0, 0)
};
...
void LIB_HANDLER()
{
    ...
    if(ISBINARYOP(CurOpcode)) {
        ...
        case OVR_ADD:
        {
            ...
            if(rplMatrixIsPolar(a) || rplMatrixIsPolar(b))
                rplMatrixAddPolar(0);
            else
                rplMatrixAdd();
            return;
        ...
        case OVR_POW:
        {
            ...
            while(ISSYMBOLIC(*b)) {
                ...
                if((*b == CMD_OVR_UMINUS) || (*b == CMD_OVR_NEG)) {
                    neg ^= 1;
                    ++b;
                }
            ...
            while(exp) {
                if(exp & 1) {
                    if(!hasresult) {
                        rplPushData(rplPeekData(1));    // DUP THE CURRENT MATRIX
                        hasresult = 1;
                    }
                    else {
    ...
    case TODIAG:
    {
        ...
        for(i = 1; i <= nrows; ++i)
            rplPushData(rplMatrixFastGet(*matptr, i, i));
    ...
    case FROMDIAG:
    {
        ...
        for(i = 1; i <= dcols; ++i) {
            *rplMatrixFastGetEx(first, cols, i, i) =
    ...
    case REMROW:
    {
        ...
        // MAKE A NEW VECTOR/MATRIX
        if(rows)
            newmat = rplMatrixCompose(nrows - 1, cols);
        else
            newmat = rplMatrixCompose(0, nrows - 1);
        if(!newmat) {
            DSTop = matptr + 2;
            return;
        }
    ...
    case DOMATPOST:
    {
        ...
        newmat[0] = MK_PROLOG(DOMATRIX, totalsize - 1);
        ...
        for(k = newdepth; k >= 1; --k) {
            rplCopyObject(newobj, rplPeekData(k));
        ...
        for(k = 0; k < nelem; ++k) {
            ...
            for(oldidx = 0, oldptr = oldfirst; oldptr < oldobj; ++oldidx)
                oldptr = rplSkipOb(oldptr);
            // FIND THE OBJECT ON THE NEW MATRIX
            for(newobj = firstobj; oldidx > 0; --oldidx)
                newobj = rplSkipOb(newobj);
    ...
    case AXL:
    {
        ...
        if(ISLIST(*rplPeekData(1))) {
            ...
            if(rows) {
                ...
                for(i = 0; i < rows; ++i) {
                    for(j = 0; j < cols; ++j) {
                        rplPushData(rplGetListElementFlat(*lst,
                                    i * cols + j + 1));
                    }
                }
            }
    ...
    case CON:
    {
        ...
        if(ISIDENT(*rplPeekData(2))) {
            ...
            if(!var)
                var = rplFindGlobal(rplPeekData(2), 1);
            if(!var) {
...
#undef MATOFFSET
        ...
        for(j = 1; j <= cols; ++j) {
            ...
            for(k = 1; k <= rows; ++k) {
                if(k >= j) {
                    ...
                    if(j > 1) {
                        rplPushData(*rplMatrixFastGetEx(first, cols, j - 1,
                                    j - 1));
                        if(Exceptions) {
                            DSTop = savestk;
                            return;
    ...
    case PMINI:
    {
        ...
        for(k = 1; k <= (nrows + 1); ++k) {
            for(j = 1; j <= nrows; ++j) {
                *rplMatrixFastGetEx(firstelem, nrows + 1, j, k) =
                        rplMatrixFastGet(a[k], 1, j);
            }
        }
        ...
        for(j = 0, k = nrows; k >= 1; --k) {
            if(rplSymbIsZero(*rplMatrixFastGetEx(firstelem, nrows + 1, k, k)))
                continue;
            if(!j)
                j = k + 1;
    ...
    case RDM:
    {
        ...
        if(actualelem > totalelem)
            rplDropData(actualelem - totalelem);        // TRIM EXCESS ELEMENTS
        else {
            // FILL WITH ZEROS
    ...
    case RSD:
    {
        ...
        if(!ISMATRIX(*rplPeekData(3)) || !ISMATRIX(*rplPeekData(2))
                || !ISMATRIX(*rplPeekData(1))) {
            rplError(ERR_MATRIXEXPECTED);
            return;
        }
...
#undef MATOFFSET
    ...
    case TRAN:
    {
        ...
        if(rows == 0)
            return;     // VECTORS DON'T NEED TO BE TRANSPOSED, BUT NO NEED TO ERROR ON THAT
...
#undef STACKELEM
        ...
        for(k = 1; k <= rows; ++k) {
            for(j = 1; j <= cols; ++j) {
                if(j != k)
                    ...
                    rplPushData(*rplMatrixFastGetEx(first, cols, k, k));
                    if(k > 1) {
                        rplPushData(*rplMatrixFastGetEx(first, cols, k - 1,
                                    k - 1));
                        rplCallOvrOperator(CMD_OVR_MUL);
                    }
                }
    ...
    case OPCODE_COMPILE:
        ...
        if(*utf8nskip((char *)TokenStart, (char *)BlankStart,
                    TokenLen - 1) == ']') {
            ...
            // MAKE HOLE IN MEMORY
            memmovew(matrix + 2 + totalelements, matrix + 2,
                    endofobjects - (matrix + 2));
                ...
                while(ptr < endofobjects) {
                    if(rplCompareObjects(ptr, objptr)) {
                        ...
                        for(count = 0; count < totalelements; ++count)
                            if(index[count] == (WORD) (ptr - matrix))
                                index[count] = objptr - matrix;
    ...
    case OPCODE_DECOMPILE:
        ...
        if(IS_PROLOG(*DecompileObject)) {
            ...
            if(doublebracket)
                rplDecompDoHintsWidth(HINT_NLAFTER | HINT_SUBINDENTAFTER);
        ...
        // FIRST, CHECK THAT THE OBJECT IS ALLOWED WITHIN AN ARRAY
    {
        ...
        if(LastCompiledObject == matrix + 1) {
            ...
            memmovew(LastCompiledObject + 1, LastCompiledObject,
                    CompileEnd - 1 - LastCompiledObject);
            ...
            if(rows <= 1) {
                matrix[1] = MATMKSIZE(rows, cols + 1);
            }
    ...
    case OPCODE_GETINFO:
        ...
        if(IS_PROLOG(*ObjectPTR)) {
            ...
            DecompHints = 0;
            RetNum = OK_TOKENINFO | MK_TOKEN_INFO(0, TITYPE_MATRIX, 0, 1);
        }
        else {
        ...
        // AND RetNum=OK_CONTINUE;
    {
        ...
        ObjectPTR = ROMPTR_TABLE[MENU_NUMBER(MenuCodeArg) + 10];
        RetNum = OK_CONTINUE;
        return;
    }
