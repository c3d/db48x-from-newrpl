...
#define COMMAND_LIST \
    CMD(PUT,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(PUTI,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(GET,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(GETI,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(HEAD,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(TAIL,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    ECMD(OBJDECOMP,"OBJ→",MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(REPL,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(POS,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(NPOS,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(POSREV,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(NPOSREV,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(SUB,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(SIZE,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(RHEAD,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(RTAIL,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2))
        ...
        if(ISSYMBOLIC(*comp)) {
            ...
            if(nitems > 1) {
                ...
                if(*rplPeekData(1) == CMD_OVR_FUNCEVAL) {
                    --nitems;
                    word_p number = rplNewSINT(nitems - 2, DECBINT);
