...
#define COMMAND_LIST \
    CMD(SETPREC,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(GETPREC,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(FLOOR,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(CEIL,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(IP,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(FP,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(MODSTO,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(MODRCL,MK_TOKEN_INFO(6,TITYPE_FUNCTION,0,2)), \
    CMD(POWMOD,MK_TOKEN_INFO(6,TITYPE_FUNCTION,2,2)), \
    CMD(MOD,MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    CMD(SQ,MK_TOKEN_INFO(2,TITYPE_FUNCTION,1,2)), \
    CMD(NEXTPRIME,MK_TOKEN_INFO(9,TITYPE_FUNCTION,1,2)), \
    ECMD(FACTORIAL,"!",MK_TOKEN_INFO(1,TITYPE_POSTFIXOP,1,3)), \
    ECMD(ISPRIME,"ISPRIME?",MK_TOKEN_INFO(8,TITYPE_FUNCTION,1,2)), \
    CMD(MANT,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(XPON,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(SIGN,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    ECMD(PERCENT,"%",MK_TOKEN_INFO(1,TITYPE_FUNCTION,2,2)), \
    ECMD(PERCENTCH,"%CH",MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    ECMD(PERCENTTOT,"%T",MK_TOKEN_INFO(2,TITYPE_FUNCTION,2,2)), \
    CMD(GCD,MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    CMD(LCM,MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    CMD(IDIV2,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(IQUOT,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(ADDTMOD,MK_TOKEN_INFO(7,TITYPE_FUNCTION,2,2)), \
    CMD(SUBTMOD,MK_TOKEN_INFO(7,TITYPE_FUNCTION,2,2)), \
    CMD(MULTMOD,MK_TOKEN_INFO(7,TITYPE_FUNCTION,2,2)), \
    CMD(PEVAL,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(PCOEF,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(IEGCD,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(IABCUV,MK_TOKEN_INFO(6,TITYPE_FUNCTION,2,2)), \
    CMD(PTCHEBYCHEFF,MK_TOKEN_INFO(11,TITYPE_FUNCTION,1,2)), \
    CMD(PLEGENDRE,MK_TOKEN_INFO(8,TITYPE_FUNCTION,1,2)), \
    CMD(PHERMITE,MK_TOKEN_INFO(7,TITYPE_FUNCTION,1,2)), \
    CMD(PTCHEBYCHEFF2,MK_TOKEN_INFO(12,TITYPE_FUNCTION,1,2)), \
    CMD(PHERMITE2,MK_TOKEN_INFO(8,TITYPE_FUNCTION,1,2)), \
    CMD(DIV2,MK_TOKEN_INFO(4,TITYPE_FUNCTION,2,2)), \
    CMD(PDIV2,MK_TOKEN_INFO(5,TITYPE_FUNCTION,2,2)), \
    CMD(PDER,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(PINT,MK_TOKEN_INFO(4,TITYPE_FUNCTION,1,2)), \
    CMD(PMUL,MK_TOKEN_INFO(4,TITYPE_FUNCTION,2,2)), \
    CMD(PADD,MK_TOKEN_INFO(4,TITYPE_FUNCTION,2,2)), \
    CMD(PSUB,MK_TOKEN_INFO(4,TITYPE_FUNCTION,2,2)), \
    ECMD(IPPOST,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,1,2)), \
    CMD(MIN,MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    CMD(MAX,MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    CMD(RND,MK_TOKEN_INFO(3,TITYPE_FUNCTION,2,2)), \
    CMD(TRNC,MK_TOKEN_INFO(4,TITYPE_FUNCTION,2,2)), \
    CMD(DIGITS,MK_TOKEN_INFO(6,TITYPE_FUNCTION,3,2)), \
    CMD(PROOT,MK_TOKEN_INFO(5,TITYPE_FUNCTION,1,2)), \
    CMD(PREVPRIME,MK_TOKEN_INFO(9,TITYPE_FUNCTION,1,2)), \
    CMD(FACTORS,MK_TOKEN_INFO(7,TITYPE_FUNCTION,1,2))
...
ROMOBJECT ipsymbolic_seco[] = {
    ...
    MK_OPCODE(LIBRARY_NUMBER, IPPOST),   // POST-PROCESS RESULTS AND CLOSE THE LOOP
    CMD_SEMI
};
...
void LIB_HANDLER()
{
    ...
    case FACTORIAL:
    {
        ...
        if(ISSYMBOLIC(*arg) || ISIDENT(*arg) || ISCONSTANT(*arg)) {
            rplSymbApplyOperator(MK_OPCODE(LIBRARY_NUMBER, FACTORIAL), 1);
            return;
        }
...
//        else
        ...
        rplCallOperator(MK_OPCODE(LIBRARY_NUMBER, IEGCD));
        if(Exceptions) {
            if(DSTop > savestk)
                DSTop = savestk;
            return;
