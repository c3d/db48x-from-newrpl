...
#define COMMAND_LIST \
    CMD(SDRESET,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDSETPART,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDSTO,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDRCL,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDCHDIR,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDUPDIR,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDCRDIR,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDPGDIR,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDPURGE,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDOPENRD,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDOPENWR,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDOPENAPP,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDOPENMOD,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDCLOSE,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDREADTEXT,MK_TOKEN_INFO(10,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDWRITETEXT,MK_TOKEN_INFO(11,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDREADLINE,MK_TOKEN_INFO(10,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDSEEKSTA,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDSEEKEND,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDSEEKCUR,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDTELL,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDFILESIZE,MK_TOKEN_INFO(10,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDEOF,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDOPENDIR,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDNEXTFILE,MK_TOKEN_INFO(10,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDNEXTDIR,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDNEXTENTRY,MK_TOKEN_INFO(11,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDMOVE,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDCOPY,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDPATH,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDFREE,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDARCHIVE,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDRESTORE,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2)), \
    CMD(SDGETPART,MK_TOKEN_INFO(9,TITYPE_NOTALLOWED,1,2))
