...
extern void newRealFromText(REAL *result,char *text,int textlen);
...
extern char *formatReal(REAL *number, char *buffer, BINT format, UBINT chars);

// RETURNS AN ESTIMATED SIZE OF BUFFER GUARANTEED TO HOLD THE TEXT
// GENERATED BY formatReal()
extern BINT formatlengthReal(REAL *number,int format);
