...
#define COMMAND_LIST \
    ECMD(UNPROTECTSTACK,"",MK_TOKEN_INFO(0,TITYPE_NOTALLOWED,1,2)), \
    CMD(CLEAR,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(DEPTH,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(DROP,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(DROP2,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(DROPN,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(DUP,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(DUP2,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(DUPDUP,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(DUPN,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(NDUPN,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(NIP,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(OVER,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(PICK,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(PICK3,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(ROLL,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(ROLLD,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(ROT,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(SWAP,MK_TOKEN_INFO(4,TITYPE_NOTALLOWED,1,2)), \
    CMD(UNPICK,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(UNROT,MK_TOKEN_INFO(5,TITYPE_NOTALLOWED,1,2)), \
    CMD(IFT,MK_TOKEN_INFO(3,TITYPE_NOTALLOWED,1,2)), \
    CMD(IFTE,MK_TOKEN_INFO(4,TITYPE_FUNCTION,3,2)), \
    CMD(STKPUSH,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(STKPOP,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2)), \
    CMD(STKDROP,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(STKPICK,MK_TOKEN_INFO(7,TITYPE_NOTALLOWED,1,2)), \
    CMD(STKDEPTH,MK_TOKEN_INFO(8,TITYPE_NOTALLOWED,1,2)), \
    CMD(STKNEW,MK_TOKEN_INFO(6,TITYPE_NOTALLOWED,1,2))
...
ROMOBJECT unprotect_seco[] = {
    MK_PROLOG(DOCOL, 2),
    MK_OPCODE(LIBRARY_NUMBER, UNPROTECTSTACK),
    CMD_SEMI
};
...
void LIB_HANDLER()
{
        ...
        //  PICK A VALUE FROM ANY SNAPSHOT
    {
        ...
        word_p newbint = rplNewBINT(depth, DECBINT);
        if(!newbint)
            return;
