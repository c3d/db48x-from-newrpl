...
BINT rplComplexClass(WORDPTR complex)
{
    ...
    if(iflags & F_NOTANUMBER)
        return CPLX_NAN;
    if(rplIsNumberZero(re)) {
        if(cclass & CPLX_POLAR)
            return CPLX_ZERO;
        if(rplIsNumberZero(im))
            return CPLX_ZERO;
    }
        ...
        case OVR_MUL:
        {
            ...
            case CPLX_INF | CPLX_POLAR:
            {
                ...
                case CPLX_NORMAL:
                {
                    ...
                    trig_atan2(&Iarg2, &Rarg2,
                            (amode1 == ANGLEDMS) ? ANGLEDEG : amode1);
                    finalize(&RReg[0]);
            ...
            case CPLX_NORMAL:
            {
                ...
                case CPLX_INF | CPLX_POLAR:
                {
                    ...
                    trig_atan2(&Iarg1, &Rarg1,
                            (amode2 == ANGLEDMS) ? ANGLEDEG : amode2);
                    normalize(&RReg[0]);
...
//                  else { copyReal(&RReg[0],&Rarg2); copyReal(&RReg[1],&Iarg2); }
                ...
                case CPLX_NORMAL:
                {
                    ...
                    if(iszeroReal(&Iarg2)) {
                        ...
                        if(amode1 == ANGLEDMS) {
                            ...
                            mulReal(&RReg[4], &Rarg2, &Iarg1);

                        trig_reduceangle(&RReg[4],
                                (amode1 == ANGLEDMS) ? ANGLEDEG : amode1);
        ...
        case OVR_SAME:
        {
            ...
            case CPLX_NORMAL:
            {
                ...
                case CPLX_NORMAL:
                {
                    if(eqReal(&Rarg1, &Rarg2) && eqReal(&Iarg1, &Iarg2))
                        rplPushTrue();
                    else
                        rplPushFalse();
                    return;
                ...
                case CPLX_NORMAL | CPLX_POLAR:
                {
                    ...
                    if(eqReal(&Rarg1, &RReg[0]) && eqReal(&Iarg1, &RReg[1]))
                        rplPushTrue();
                    else
                        rplPushFalse();
                    return;
            ...
            case CPLX_NORMAL | CPLX_POLAR:
            {
                ...
                case CPLX_NORMAL:
                {
                    ...
                    if(eqReal(&RReg[0], &Rarg2) && eqReal(&RReg[1], &Iarg2))
                        rplPushTrue();
                    else
                        rplPushFalse();
                    return;
            ...
            case CPLX_INF:
            {
                ...
                case CPLX_INF:
                {
                    if((Rarg1.flags & F_NEGATIVE) == (Rarg2.flags & F_NEGATIVE))
                        rplPushTrue();
                    else
                        rplPushFalse();
                    return;
            ...
            case CPLX_INF | CPLX_MALFORMED:
            {
                ...
                case CPLX_INF | CPLX_MALFORMED:
                {
                    if((Iarg1.flags & F_NEGATIVE) == (Iarg2.flags & F_NEGATIVE))
                        rplPushTrue();
                    else
                        rplPushFalse();
                    return;
        ...
        case OVR_AND:
        {
            if((cclass1 == CPLX_ZERO) || (cclass2 == CPLX_ZERO))
                rplPushFalse();
            else
                rplPushTrue();
            return;
...
#undef arg2
...

    {
        ...
        if((LIBNUM(CurrentConstruct) == LIBRARY_NUMBER)
            ...
            if((WORD) utf82cp(utf8rskip((char *)BlankStart, (char *)ptr),
                        (char *)BlankStart) == ARG_SEP(Locale)) {
    ...
    case OPCODE_CHECKOBJ:
        ...
        if(ISPROLOG(*ObjectPTR)) {
            ...
            if(rplSkipOb(imag) != rplSkipOb(ObjectPTR)) {
                RetNum = ERR_INVALID;
                return;
            }
