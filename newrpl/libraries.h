...
#define IDATTR_ISCPLX 5
#define IDATTR_ISINFREAL 2
#define IDATTR_ISINFCPLX 4
#define IDATTR_ISMATRIX 6
#define IDATTR_ISUNKNOWN 8

#define IDATTR_NOTZERO (1<<4)
#define IDATTR_GTEZERO (2<<4)
#define IDATTR_LTEZERO (4<<4)

#define IDATTR_INTEGER (1<<8)
...
extern const WORD four_bint[];
extern const WORD five_bint[];
extern const WORD six_bint[];
extern const WORD seven_bint[];
extern const WORD eight_bint[];
extern const WORD nine_bint[];
extern const WORD ten_bint[];
extern const WORD eleven_bint[];
extern const WORD twelve_bint[];
extern const WORD thirteen_bint[];
extern const WORD fourteen_bint[];
extern const WORD fifteen_bint[];
extern const WORD one_real[];
extern const WORD one_half_real[];
extern const WORD empty_string[];
extern const WORD empty_list[];
extern const WORD angle_0[];
extern const WORD angle_90[];
extern const WORD angle_180[];
extern const WORD angle_270[];
