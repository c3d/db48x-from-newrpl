...
#define IDATTR_DEFN         1       // VARIABLE HAS A DEFINITION: A FORMULA/PROGRAM THAT NEEDS TO BE EVALUATED
...
#define IDATTR_DONTUSE     16       // RESERVED FOR INTERNAL USE - TEMPORARILY USED TO MARK VARIABLES THAT ARE NOT DEPENDENCIES
...
#define IDATTR_CONST        256     // IDENTIFIER IS A CONSTANT
#define IDATTR_REAL         512     // IDENTIFIER IS A REAL VARIABLE (EVEN IN COMPLEX MODE)
#define IDATTR_NOTSCALAR    1024    // IDENTIFIER IS NOT A SCALAR VALUE (DISABLE COMMUTATIVE MULTIPLICATION)
