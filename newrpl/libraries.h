...
#define CMD_LOG   MKOPCODE(66,15)
#define CMD_ALOG  MKOPCODE(66,16)
#define CMD_DEG  MKOPCODE(66,17)
#define CMD_GRAD MKOPCODE(66,18)
#define CMD_RAD  MKOPCODE(66,19)
#define CMD_SQRT MKOPCODE(66,20)
#define CMD_PINUM MKOPCODE(66,21)
