...
void switchmenukeysKeyHandler(BINT keymsg)
{
    UNUSED_ARGUMENT(keymsg);
...
// NORMAL COMMANDS/FUNCTIONS
    ...
    {KM_PRESS | KB_8 | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                &curlyBracketKeyHandler},
    {KM_PRESS | KB_8 | SHIFT_ALPHA | SHIFT_LS, CONTEXT_ANY,
                &curlyBracketKeyHandler},
    {KM_PRESS | KB_8 | SHIFT_ALPHA | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                &curlyBracketKeyHandler},

    {KM_PRESS | KB_8 | SHIFT_RS, CONTEXT_ANY, &secoBracketKeyHandler},
    {KM_PRESS | KB_8 | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                &secoBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_RS, CONTEXT_ANY, &secoBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
            &secoBracketKeyHandler},
    {KM_PRESS | KB_8 | SHIFT_ALPHA | SHIFT_RS, CONTEXT_ANY,
                &secoBracketKeyHandler},
    {KM_PRESS | KB_8 | SHIFT_ALPHA | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                &secoBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_ALPHA | SHIFT_RS, CONTEXT_ANY,
                &secoBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_ALPHA | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                &secoBracketKeyHandler},

    {KM_PRESS | KB_N | SHIFT_LS, CONTEXT_ANY, &parenBracketKeyHandler},
    {KM_PRESS | KB_N | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                &parenBracketKeyHandler},
    {KM_PRESS | KB_N | SHIFT_ALPHA | SHIFT_LS, CONTEXT_ANY,
                &parenBracketKeyHandler},
    {KM_PRESS | KB_N | SHIFT_ALPHA | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                &parenBracketKeyHandler},

    {KM_PRESS | KB_5 | SHIFT_LS, CONTEXT_ANY, &squareBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                &squareBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_ALPHA | SHIFT_LS, CONTEXT_ANY,
                &squareBracketKeyHandler},
    {KM_PRESS | KB_5 | SHIFT_ALPHA | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                &squareBracketKeyHandler},
    ...
    {KM_PRESS | KB_0 | SHIFT_ALPHA | SHIFT_RS, CONTEXT_ANY,
                &textBracketKeyHandler},
    ...
    {KM_PRESS | KB_SUB | SHIFT_ALPHA | SHIFT_RS, CONTEXT_ANY,
                KEYHANDLER_NAME(colon)},
    {KM_PRESS | KB_SUB | SHIFT_ALPHA | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(colon)},
    ...
    {KM_PRESS | KB_9 | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_E | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                &tonumKeyHandler},
    ...
    {KM_PRESS | KB_F | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(xroot)},

    {KM_PRESS | KB_J | SHIFT_ALPHA | SHIFT_LS, CONTEXT_ANY,
                KEYHANDLER_NAME(econst)},
    {KM_PRESS | KB_J | SHIFT_ALPHA | SHIFT_LSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(econst)},
    {KM_PRESS | KB_J | SHIFT_LS, CONTEXT_ANY, KEYHANDLER_NAME(exp)},
    {KM_PRESS | KB_J | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(exp)},
    {KM_PRESS | KB_J , CONTEXT_ANY, KEYHANDLER_NAME(ln)},
    {KM_PRESS | KB_J | SHIFT_RS , CONTEXT_ANY, KEYHANDLER_NAME(econst)},
    {KM_PRESS | KB_J | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(econst)},
    ...
    {KM_PRESS | KB_C | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(convert)},

    {KM_PRESS | KB_SUB | SHIFT_LS | SHIFT_LSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(basecycle)},
    {KM_PRESS | KB_SUB | SHIFT_LS | SHIFT_LSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(basecycle)},
...
// SYMBOLS
    {KM_PRESS | KB_7 | SHIFT_RS | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(question)},
    {KM_PRESS | KB_7 | SHIFT_RS | SHIFT_RSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(openquestion)},
    {KM_PRESS | KB_P | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(delta)},
    {KM_PRESS | KB_P | SHIFT_LS | SHIFT_LSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(delta)},
    ...
    {KM_PRESS | KB_9 | SHIFT_RS | SHIFT_RSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_9 | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_4 | SHIFT_LS | SHIFT_LSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(pound)},

    {KM_PRESS | KB_MUL | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(angle)},
    {KM_PRESS | KB_MUL | SHIFT_LS , CONTEXT_ANY,
                KEYHANDLER_NAME(angle)},
    ...
    {KM_PRESS | KB_E | SHIFT_LS , CONTEXT_ANY,
                KEYHANDLER_NAME(degree)},
    {KM_PRESS | KB_E | SHIFT_LS | SHIFT_LSHOLD , CONTEXT_ANY,
                KEYHANDLER_NAME(degree)},
    {KM_PRESS | KB_E | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(degree)},
    {KM_PRESS | KB_E | SHIFT_LS | SHIFT_LSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(degree)},


    {KM_PRESS | KB_2 | SHIFT_LS , CONTEXT_ANY,
    ...
    {KM_PRESS | KB_DOT | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
...
// MENUS
    ...
    {KM_PRESS | KB_A | SHIFT_RS | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(backmenu1)},
    {KM_PRESS | KB_A | SHIFT_RS | SHIFT_RSHOLD, CONTEXT_ANY,
                KEYHANDLER_NAME(backmenu2)},
    {KM_PRESS | KB_A | SHIFT_RS | SHIFT_RSHOLD | SHIFT_ALPHA, CONTEXT_ANY,
                KEYHANDLER_NAME(backmenu2)},
...
// GREEK LETTERS
    ...
    {KM_PRESS | KB_HLP | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_VIE | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_MEN | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_APP | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
    ...
    {KM_PRESS | KB_HOM | SHIFT_LS | SHIFT_ALPHA, CONTEXT_ANY,
