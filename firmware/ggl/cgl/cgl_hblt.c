...
void cgl_hblt_g2c(int *dest, int destoff, int *src, int srcoff, int npixels)
{
...
*/
void cgl_hblt(int *dest, int destoff, int *src, int srcoff, int npixels)
{
