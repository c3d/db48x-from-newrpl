...
// PC IMPLEMENTATION
#define DSTK_SIZE 262144     // 1MB FOR DATA STACK MAXIMUM
#define RSTK_SIZE 262144     // 1MB FOR RETURN STACK
#define DIR_SIZE  262144     // 1MB FOR DIRECTORIES
#define LAM_SIZE  262144     // 1MB FOR LAMS
#define TEMPOB_SIZE 262144   // 1MB FOR TEMPOB
#define TEMPBLK_SIZE  262144 // 1MB FOR TEMP BLOCKS
