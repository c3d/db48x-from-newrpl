...
#define RSTK_SIZE 16384     // 64K FOR RETURN STACK
#define DIR_SIZE  16384     // 64K FOR DIRECTORIES
#define LAM_SIZE  16384     // 64K FOR LAMS
#define TEMPOB_SIZE 65536   // 256K FOR TEMPOB
