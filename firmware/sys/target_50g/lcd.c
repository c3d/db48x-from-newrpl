...
LCDPTR[2]&=0x7ff00;
if(freq>37500000) LCDPTR[2]|=0x80000;   // USE WDLY=32 HCLK
if(freq>60000000) LCDPTR[2]|=0x100000;  // USE WDLY=64 HCLK

LCDPTR[2]|=lineblank;

// FORCE WLH=0;
LCDPTR[3]&=0xFFFFFF00;
if(freq>37500000) LCDPTR[3]|=1;
if(freq>60000000) LCDPTR[3]|=2;
