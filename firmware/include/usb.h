...
#define PRODUCT_ID_HP_50G          0x121  // ORIGINAL VID/PID OF THE 50g/39gs/40g TARGET HARDWARE
#define PRODUCT_ID_HP_PRIME_UPDATE 0x441  // PID OF THE Prime UPDATE MODE [NW280AA, G8X92AA] TARGET HARDWARE
#define PRODUCT_ID_HP_PRIME        0x1541 // ORIGINAL PID OF Prime [NW280AA, G8X92AA] TARGET HARDWARE

#ifndef TARGET_PRIME
#  define PRODUCT_ID PRODUCT_ID_HP_PRIME
#else // TARGET_PRIME
#  define PRODUCT_ID PRODUCT_ID_HP_50G
#endif // TARGET_PRIME


// You can change these to give your code its own name.
#define STR_MANUFACTURER                                                                   \
  {                                                                                        \
    'n', 0, 'e', 0, 'w', 0, 'R', 0, 'P', 0, 'L', 0, ' ', 0, 'T', 0, 'e', 0, 'a', 0, 'm', 0 \
  }
#define STR_MANUFLENGTH 22 + 2
#define STR_PRODUCT                                                                        \
  {                                                                                        \
    'n', 0, 'e', 0, 'w', 0, 'R', 0, 'P', 0, 'L', 0, ' ', 0, 'C', 0, 'a', 0, 'l', 0, 'c', 0 \
  }
...
#define P_FILEID(pptr) (((int32_t) ((pptr)->p_fileidLSB)) | (((int32_t) ((pptr)->p_fileidMSB)) << 8))
...
extern int32_t          usb_lastgood_offset;                 // LAST KNOWN GOOD OFFSET WITHIN THE FILE
