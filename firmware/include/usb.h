...
extern BYTE __usb_ctlbuffer[10*RAWHID_RX_SIZE+1] ;  // BUFFER TO RECEIVE CONTROL PACKETS IN THE CONTROL CHANNEL
extern BYTE __usb_tmprxbuffer[10*RAWHID_RX_SIZE+1] ;  // TEMPORARY BUFFER TO RECEIVE DATA
extern BYTE __usb_ctlrxbuffer[10*RAWHID_RX_SIZE+1] ;  // TEMPORARY BUFFER TO RECEIVE CONTROL PACKETS
extern BYTE __usb_ctltxbuffer[10*RAWHID_TX_SIZE+1] ;  // TEMPORARY BUFFER TO TRANSMIT DATA
