...
// Theme colors for stack
#define GTHEME_STKBACKGND PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_STKINDEX   PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_STKVLINE   PATTERN_SOLID(PAL_GRAY8)
#define GTHEME_STKIDXBACKGND   PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_STKITEMS   PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_STKSELBKGND PATTERN_SOLID(PAL_GRAY6)
#define GTHEME_STKSELITEM  PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_STKCURSOR   PATTERN_SOLID(PAL_GRAY15)

// Theme colors for command line
#define GTHEME_CMDBACKGND  PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_CMDTEXT     PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_CMDSELBACKGND PATTERN_SOLID(PAL_GRAY6)
#define GTHEME_CMDSELTEXT  PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_CMDCURSORBACKGND PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_CMDCURSOR   PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_DIVLINE     PATTERN_SOLID(PAL_GRAY8)

// Theme colors for menu
#define GTHEME_MENUBACKGND PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_MENUINVBACKGND PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_MENUTEXT    PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_MENUINVTEXT PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_MENUDIRMARK PATTERN_SOLID(PAL_GRAY8)
#define GTHEME_MENUINVDIRMARK PATTERN_SOLID(PAL_GRAY6)
#define GTHEME_MENUHLINE   PATTERN_SOLID(PAL_GRAY8)
#define GTHEME_MENUFOCUSHLINE PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_MENUPRESSBACKGND RGB_TO_RGB16(255,0,0)
#define GTHEME_MENUPRESSINVBACKGND RGB_TO_RGB16(255,0,0)

// Theme colors for status area
#define GTHEME_STABACKGND  PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_STATEXT     PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_STAANNPRESS PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_STAANN      PATTERN_SOLID(PAL_GRAY8)
#define GTHEME_STABAT      PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_STAUFLAG0   PATTERN_SOLID(PAL_GRAY8)
#define GTHEME_STAUFLAG1   PATTERN_SOLID(PAL_GRAY15)

// Theme colors for help and popup messages
#define GTHEME_HLPBACKGND PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_HLPTEXT    PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_HLPLINES   PATTERN_SOLID(PAL_GRAY8)

// Theme colors for Forms
#define GTHEME_FORMBACKGND PATTERN_SOLID(PAL_GRAY0)
#define GTHEME_FORMTEXT    PATTERN_SOLID(PAL_GRAY15)
#define GTHEME_FORMSELTEXT PATTERN_SOLID(PAL_GRAY15)
