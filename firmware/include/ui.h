...
#define PAL_HELP_BG          ggl_color(48)
#define PAL_HELP_TEXT        ggl_color(49)
#define PAL_HELP_LINES       ggl_color(50)
#define PAL_HELP_TITLE       ggl_color(51)
#define PAL_HELP_BOLD        ggl_color(52)
#define PAL_HELP_ITALIC      ggl_color(53)
#define PAL_HELP_CODE        ggl_color(54)
#define PAL_HELP_CODE_BG     ggl_color(55)
...
// Colors for errors
#define PAL_ERROR            ggl_color(61)
#define PAL_ERROR_BG         ggl_color(62)
#define PAL_ERROR_LINE       ggl_color(63)
