...
#define OP_LIST \
    OP(INV,MKTOKENINFO(3,TITYPE_FUNCTION,1,20)), \
    OP(NEG,MKTOKENINFO(3,TITYPE_FUNCTION,1,20)), \
    OP(EVAL,MKTOKENINFO(4,TITYPE_FUNCTION,1,20)), \
    OP(XEQ,MKTOKENINFO(3,TITYPE_FUNCTION,1,20)), \
    OP(ABS,MKTOKENINFO(3,TITYPE_FUNCTION,1,20)), \
    OP(ISTRUE,MKTOKENINFO(6,TITYPE_FUNCTION,1,20)), \
    OP(NOT,MKTOKENINFO(3,TITYPE_FUNCTION,1,20)), \
    OP(EQ,MKTOKENINFO(2,TITYPE_BINARYOP_LEFT,2,9)), \
    OP(NOTEQ,MKTOKENINFO(2,TITYPE_BINARYOP_LEFT,2,9)), \
    OP(LT,MKTOKENINFO(1,TITYPE_BINARYOP_LEFT,2,8)), \
    OP(GT,MKTOKENINFO(1,TITYPE_BINARYOP_LEFT,2,8)), \
    OP(LTE,MKTOKENINFO(2,TITYPE_BINARYOP_LEFT,2,8)), \
    OP(GTE,MKTOKENINFO(2,TITYPE_BINARYOP_LEFT,2,8)), \
    OP(SAME,MKTOKENINFO(1,TITYPE_FUNCTION,2,20)), \
    OP(AND,MKTOKENINFO(3,TITYPE_BINARYOP_LEFT,2,10)), \
    OP(OR,MKTOKENINFO(2,TITYPE_BINARYOP_LEFT,2,12)), \
    OP(XOR,MKTOKENINFO(3,TITYPE_BINARYOP_LEFT,2,11)), \
    OP(CMP,MKTOKENINFO(3,TITYPE_FUNCTION,2,8)), \
    OP(ADD,MKTOKENINFO(1,TITYPE_BINARYOP_LEFT,2,6)), \
